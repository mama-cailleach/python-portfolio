...
canvas_width, canvas_height = 200, 360
frames = []
total_frames = 60
...
lift_offsets_y = [160, 165, 170]  # Different heights for varied movement
lift_offsets_x = [20, 30, 40]  # Slightly different horizontal offsets
